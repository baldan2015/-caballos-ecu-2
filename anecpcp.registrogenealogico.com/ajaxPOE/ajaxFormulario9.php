...
//echo $tipo;
		...
		$prefijoTipo="";
		if($tipo=="T"){
			$classHtml="class='gridHtml'";
			$propietario="Nuevo Propietario";
			$fecEvento="Fecha";
		}
		else{
			$prefijoTipo="Adqui";
			 $classHtml="class='gridHtmlAdqui'";
			 $propietario="Antiguo Propietario";
			 $fecEvento="Fecha";
		}
		$html = "";
		$html.= "<table $classHtml style='width:100%;border-collapse:collapse;' border=1 >";
		$html.= "<thead style='background:#d3d3d3;'>";
		$html.= "<tr>";
		//$html.= "<th>Tipo</th>";
		$html.= "<th style='height:35px;'> Nombre</th>";
		$html.= "<th>Sexo</th>";
		$html.= "<th>Pelaje</th>";
		$html.= "<th>Fec. Nac.</th>";
		$html.= "<th>Padre</th>";
				...
				$queryAddonPeriodoIni="UNION ALL
 				...
 				a.codigo not in (
	 							select mov.codEjemplar COLLATE utf8_unicode_ci AS codigo from 
	 								poe_movimiento mov 
									left join datos220206 dat on(dat.codigo =mov.codEjemplar)
...
//echo $sql ;
	...
	function listarHtmlAdmin($link,$idpoe,$idProp){
		...
		$html .= "FORMULARIO 7 - ".$codPropietario;
		$html .= "</td>";
		$html .= "</tr>";
		$html .= "<tr>";
