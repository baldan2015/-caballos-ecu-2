...
function updateIns($codigo, $prefijo, $nombre, $fecNace, $padre, $madre, $idPelaje, $lugarNace, $microchip, $adn, $descripcion, $genero, $usuModi, $fecCapado, $idMonta, $idNac, $idProvincia, $origen, $resenias, $fecModi, $nroLibro, $nroFolio, $fecServ, $metodo, $idProp, $idPoe, $idCriador, $arrayResenias, $codigoGenerado, $idImgEliminacion, $idPdfEliminacion)
{
    $retorno = new Resultado();
    $retorno->validateTOKEN = "1";
    if (validarSesion($retorno)->result == 1) {
...
function updateNac($codigo, $prefijo, $nombre, $fecNace, $padre, $madre, $idPelaje, $lugarNace, $microchip, $adn, $descripcion, $genero, $usuModi, $fecCapado, $idMonta, $idProvincia, $origen, $resenias, $fecModi, $nroLibro, $nroFolio, $fecServ, $metodo, $idProp, $idPoe, $idCriador, $arrayResenias, $codigoGenerado, $idImgEliminacion, $idPdfEliminacion)
{
    $retorno = new Resultado();
    $retorno->validateTOKEN = "1";
    if (validarSesion($retorno)->result == 1) {
