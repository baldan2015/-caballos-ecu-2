                ...
                if(validarSesion($retorno)->result==1){    
                   $result=$obj->listarNotificaciones($idProp);
                    ...
                    foreach ($result as $key => $value) {
                     ...
                     $html.="<td colspan='4' data-toggle='tooltip' style=' cursor:pointer;'  title='". $mensaje."' onclick='popupDetalle(".$value->codigo.",".$value->idPropPotro.",".$value->flag.")'><marquee SCROLLDELAY =200>".$mensaje." </marquee></td>";
