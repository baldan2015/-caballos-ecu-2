...
if (file_exists("../logica/PropietarioLogLogica.php"))include_once("../logica/PropietarioLogLogica.php"); 
    ...
    class EjemplarLogica{
        ...
        //Guardar
        public function insertar($codigo,$prefijo,$nombre,$fecNace,$padre,$madre,$idPelaje,$lugarNace,$microchip,$adn,$descripcion,$usuario_crea,$genero,$fecCapado,$listPropietarios,$listCriadores,$fecFallece,$motivoFallece,$idProvincia,$origen,$resenias,$fecReg,$nroLibro,$nroFolio,$fecServ,$metodo,$reseniaBasica){
      ...
      if((is_array($listCriadores) && count($listCriadores)>1) ){
            $retorno->result=4;
              ...
              //  print_r($retornoProps);
                if($retornoProps->result==1){
                       ...
                       $retorno = $this->context->insertar($codigo,$prefijo,$nombre,$fecNace,$padre,$madre,$idPelaje,$lugarNace,$microchip,$adn,$descripcion,$usuario_crea,$genero,$fecCapado,$fecFallece,$motivoFallece,$idProvincia,$origen,$resenias,$fecReg,$nroLibro,$nroFolio,$fecServ,$metodo,$reseniaBasica);
         ...
         //Editar
        public function editar($codigo,$prefijo,$nombre,$fecNace,$padre,$madre,$idPelaje,$lugarNace,$microchip,$adn,$descripcion,$usuario_modi, $genero,$fecCapado,$propietarios,$criadores,$propietariosDEL,$criadoresDEL,$fecFallece,$motivoFallece,$idProvincia,$resenias,$fecReg,$nroLibro,$nroFolio,$fecServ,$metodo,$origen,$reseniaBasica){
          ...
          $resultado->result=4;
              ...
              $retornoPropos=$this->editarPropietarios($codigo,$propietarios,$propietariosDEL,1,$usuario_modi);
                  if($retornoPropos->result==1){
                           $resultado = $this->context->editar($codigo,$prefijo,$nombre,$fecNace,$padre,$madre,$idPelaje,$lugarNace,$microchip,$adn,$descripcion,$usuario_modi, $genero,$fecCapado,$fecFallece,$motivoFallece,$idProvincia,$resenias,$fecReg,$nroLibro,$nroFolio,$fecServ,$metodo,$origen,$reseniaBasica); 
                                ...
                                if($idCooProp==0 ){
                                    foreach ($propietarios as $key => $value) {
                                        ...
                                        if($propietarios[$key]['idEntidad']!=0){
                                         ...
                                         if(is_array($entidades)){
                                            foreach ($entidades as $key => $value) {
                                              $retornoProp=$dataProp->insertarPropietario($idProp,
                                                                                        $entidades[$key],
                                                                                        $usuariolog,0,1);
                                            ...
                                            $retornoProp=$dataProp->insertarCoPropietario($propietarios[$key]['idPropietario'],
                                 ...
                                 /*SI SOLO ES UN PROPIETARIO REGISTRA EL ID DE PROPIEDAD AL LOG*/
                                  if($propietarios[0]['idPropietario']!="0" ){
                                    ...
                                    $idProp=$propietarios[0]['idPropietario'];
                                      ...
                                      $dataProp = new EntidadData();
                                      $retornoPropNeo=$dataProp->insertarPropietario(0,$propietarios[0]['idEntidad'],$usuariolog,1
                                        );
  ...
  public function insertarTMP($codigo,$prefijo,$nombre,$fecNace,$padre,$madre,$idPelaje,$lugarNace,$microchip,$adn,$descripcion,$usuario_crea,$genero,$fecCapado,$listPropietarios,$listCriadores,$fecFallece,$motivoFallece,$idProvincia,$origen,$resenias,$fecReg,$nroLibro,$nroFolio,$fecServ,$metodo,$idCriador){
      ...
      if((is_array($listCriadores) && count($listCriadores)>1) ){
            $retorno->result=4;
                      ...
                      $retorno = $this->context->insertarTMP($codigo,$prefijo,$nombre,$fecNace,$padre,$madre,$idPelaje,$lugarNace,$microchip,$adn,$descripcion,$usuario_crea,$genero,$fecCapado,$fecFallece,$motivoFallece,$idProvincia,$origen,$resenias,$fecReg,$nroLibro,$nroFolio,$fecServ,$metodo,$idCriador);
         }  
            return $retorno;
        }
         //Editar
        public function editarTMP($codigo,$prefijo,$nombre,$fecNace,$padre,$madre,$idPelaje,$lugarNace,$microchip,$adn,$descripcion,$usuario_modi, $genero,$fecCapado,$propietarios,$criadores,$propietariosDEL,$criadoresDEL,$fecFallece,$motivoFallece,$idProvincia,$resenias,$fecReg,$nroLibro,$nroFolio,$fecServ,$metodo,$origen,$idCriador){
          
           $resultado=new Resultado();
        if(is_array($criadores) && count($criadores)>1 ){
          $resultado->result=4;
        }else{
                      $resultado = $this->context->editarTMP($codigo,$prefijo,$nombre,$fecNace,$padre,$madre,$idPelaje,$lugarNace,$microchip,$adn,$descripcion,$usuario_modi, $genero,$fecCapado,$fecFallece,$motivoFallece,$idProvincia,$resenias,$fecReg,$nroLibro,$nroFolio,$fecServ,$metodo,$origen,$idCriador); 
