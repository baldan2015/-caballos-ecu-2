    ...
    class ResenaData extends dal{
        ...
        */
        public function insertar($descripcion,$usuario_crea,$tipo){
            $retorno=new Resultado();
            $sql = "CALL SGESI_RESENA('$descripcion','$usuario_crea','$tipo', @vresultado)";
            //echo $sql;
        ...
        public function editar($id,$resena,$usuario_modi,$tipo){
             $retorno=new Resultado();
            $sql = "CALL SGESU_RESENA('$id','$resena','$tipo','$usuario_modi',@vresultado)";
           //echo $sql ; 
            $result = parent::ejecutar2($sql,'@vresultado');
            if($result){
                if($fila = mysqli_fetch_array($result)){
        ...
        */
        public function buscarDataTable(){
            ...
            $aColumns=array("id","descripcion","tipo");
            $sIndexColumn="id";
            $sTable="sge_resena";
        ...
        public function listarResenaTipos(){
            $retorno=new Resultado();
            $sql = "CALL SGESS_LIST_TIPO_RESENA()";
           // echo $sql;
            $result = parent::ejecutar2($sql);
        ...
        public function listarCombo($codigo,$descripcion,$tipo){
         ...
         public function buscarSearch($nomResena,$tipo,$start,$limit,$sidx,$sord){
            $sql = "CALL SGESS_RESENA_JQGRID('$nomResena','$tipo','$start','$limit','$sidx','$sord')";
            // echo $sql;
            $result = parent::ejecutar2($sql);
            $resenas=[];
            while($fila = mysqli_fetch_object($result)){
