...
<script src="script/mantenimiento/mantenimiento.inscripcion.js"></script>
...
<div style="float:left;background:#f6f6f6; width:100%; background:url('images/button/barra.png')100% 100% ;">
  <div style=" float:left; margin-top:10px;  ">
    <titulo>
      <span class="glyphicon glyphicon-list"></span> Solicitudes de Inscripciones - WEB.
    </titulo>
  </div>
  <div style=" float:right;margin-top: 5px;  " class="toolButton ">
   ...
   <span class="glyphicon glyphicon-file">&nbsp;Nuevo</span>
    ...
    <div class="btn-group" role="group" aria-label="...">
      <button id="btnUpdEstado" title="Procesar solicitud inscripción. " class="btn btn-primary    ">
        <span class="glyphicon glyphicon-cog"></span>&nbsp;Procesar Solicitud
      </button>

      <button id="btnVer" title="Buscar Inscripción" class="btn btn-default   ">
        <span class="glyphicon glyphicon-search"></span> &nbsp;Buscar
      </button>

      <button id="btnCancelarIns" title="Reiniciar filtros de busqueda  " class="btn btn-default   ">
    ...
    <button id="btnUpload"  title="Subir imagen del ejemplar" class="btn btn-primary     " > 
      ...
      <button id="btnPrintHorse" title="Imprimir Solicitud de Inscripcion" class="btn btn-default  ">
        <span class="glyphicon glyphicon-print"></span>&nbsp;Imprimir

      </button>

      <button id="btnLog" title="Seguimiento de la inscripcion" class="btn btn-default     ">
...
<div id="mvNuevoInscripcion" class="modal fade">
  <div class="modal-dialog  modal-lg modal-dialog-customer">
    <div class="modal-content " id="divContainer">
      <div class="modal-header bg-success">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <!--<h4 class="modal-title">INSCRIPCIÓN DE EJEMPLAR.</h4>-->
        <span class="modal-title"></span>
        <div style="float:right; margin-top: -10px; margin-right:40px;">
          <select class="form-control" disabled id="ddlIdNac"></select>
        </div>
        <div style="float:right; margin-top: -5px;    ">
          <label> Código Nacimiento: <span class="etiqueta">(*)</span></label>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-12" style="margin-top: 7px;">
              <label> Criador: </label><span> <select id="ddlCriador" name="ddlCriador" class="selectpicker show-tick form-control requeridoLst" data-live-search="true" data-size="5" data-width="100%"></select></span>
            </div>
          </div>
          <div class="row">
            <div class="col-md-6" style="margin-top: 7px;">
          ...
          <div class="row">
            ...
            <div class="col-md-2" id="FecEmbrion" style="margin-top: 7px;">
            ...
            <div class="col-md-2" id="idReceptora" style="margin-top: 7px;">
            ...
            <div class="col-md-2" style="margin-top: 7px;" id="IdMonta">
            ...
            <div class="col-md-2" style="margin-top: 7px;" id="IdNac">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div id="upload-wrapper">
              ...
              <h5 style="text-transform: uppercase;padding-left: 15px;font-weight: bold;">Agregar Certificados del ejemplar: <span class="badge badge-pill badge-warning-tit" id="lblDatoHorsePdf" style="font-weight: bold;"></span> </h5>
              <form action="vista/upload/uploadF2/processuploadInsPdf.php" method="post" enctype="multipart/form-data" id="MyUploadFormPdf">
...
<div class="modal fade" id="mvImagen1" role="dialog">
  <div class="modal-dialog modal-lg modal-dialog-customer-img">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <img src="" id="imgHorse1" width="100%">
      </div>
      <div class="modal-footer">
        <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
      </div>
