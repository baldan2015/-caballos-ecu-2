...
<div style="float:left;background:#f6f6f6; width:100%; background:url('images/button/barra.png')100% 100% ;">
  ...
  <div style=" float:right;margin-top: 5px;  " class="toolButton ">
    ...
    <div class="btn-group" role="group" aria-label="...">
      <button id="btnLog" title="ver detalle de Inscripción OnLine F2" class="btn btn-primary    ">
        <span class="glyphicon glyphicon-briefcase"></span>&nbsp;Historial Inscrip.
      </button>
      ...
      <button id="btnSuperCamp" style='display:none;' title="Historial de Campeón de Campeones" class="btn btn-default   ">
...
<div class="container-fluid breadcrumb  ui-widget-content ">
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <select id="ddlCria" class="selectpicker show-tick form-control" data-live-search='true' data-size=10 data-width="100%"></select>
            ...
            <tr>
              <td>
                ...
                <select id="ddlOrigen" class="requeridoLst form-control  ">
                  ...
                  <option value="A">Nacional - No concursos</option>
          ...
          <input type="text" id="txtMicrochip" class="form-control"   />
            ...
            <tr>
              ...
              <td colspan="1">
                ...
                <input type="text" id="txtNumeroFolio" class="form-control" />
              </td>
            </tr>
            <tr>
              <td>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane fade in" id="tab2">
              <div class="row">
                ...
                <div class="col-xs-2">
                  <br><br><br>
                  <button id="rightSelected" class="btn btn-block bg-success"><i class="glyphicon glyphicon-chevron-right"></i></button>
                  <button id="leftSelected" class="btn btn-block bg-success"><i class="glyphicon glyphicon-chevron-left"></i></button>
