<script src="script/mantenimiento/mantenimiento.setPoe.js"></script>
<style>
.mv-customer-pelaje { 
max-width : 100% ;
width : 90% ;
...
<titulo>
    ...
    Configurador de Parte de Ocurrencias
</titulo>
</div>
...
<input type="hidden" id="hidActionPopup" />
    ...
    <div class="tfila">  
     ...
     <div class="tfila">  
        <div class="tcelda"><label> PERIODO:  </label></div>
        <div class="tcelda"><input type="text" id="anio" class="requerido form-control"  style="width:280px;"  /></div>
    </div>
      <div class="tfila">  
        <div class="tcelda"><label> FECHA INICIO:  </label></div>
        <div class="tcelda"><input type="date" id="ini" class="requerido form-control"  style="width:280px;"  /></div>
    </div>
      <div class="tfila">  
        <div class="tcelda"><label> FECHA  FIN:  </label></div>
        <div class="tcelda"><input type="date" id="fin" class="requerido form-control"  style="width:280px;"  /></div>
    </div>
    </div>
 </div>
 </div>
