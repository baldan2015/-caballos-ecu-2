<script src="script/mantenimiento/mantenimiento.tipoDoc.js"></script>
...
<div class="container-fluid breadcrumb table-responsive" style="margin-top:45px;">
 ...
 <input type="text" id="txtTipoDoc"   style="width:280px;" class=" form-control" />
...
<input type="hidden" id="hidActionPopup" />
    ...
    <div class="tfila">  
        <div class="tcelda"><label> Nombre Corto:  </label></div>
        <div class="tcelda"><input type="text" id="txtNombreCorto" class="form-control requerido"  maxlength="10" style="width:100px;" /></div>
    </div>
    <div class="tfila">  
        <div class="tcelda"><label> Nombre Largo:  </label></div>
        <div class="tcelda"><input type="text" id="txtNombreLargo" class="form-control  requerido"  style="width:280px;" /></div>
    </div>
    </div>
 </div>
 </div>
        <div class="modal-footer">
          <button type="button" id="btnSaveTipoDoc" class="btn btn-primary" >Grabar</button>
