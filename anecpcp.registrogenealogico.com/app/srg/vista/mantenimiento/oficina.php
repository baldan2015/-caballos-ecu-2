...
<div style="margin-top:45px;" class="container-fluid breadcrumb table-responsive">
<label> Nombre de Oficina:  </label>
 <input type="text" id="txtOficina"   style="width:280px;" class=" form-control" />
...
<input type="hidden" id="hidActionPopup" />
    ...
    <div class="tfila">  
        ...
        <div class="tcelda"><input type="text" id="txtId"  disabled="true" class=" form-control"  style="width:280px;" /></div>
