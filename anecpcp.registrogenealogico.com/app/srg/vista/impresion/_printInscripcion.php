...
?>
        ...
        <table style=" padding-left: 15px; width: 100%;">
            <tr style="border: 1px solid black;width: 100%;">
                <td style="border: 1px solid black;" height="130">
        ...
        <table border=0 cellspacing="2" cellpadding="3" style=" padding-left: 15px; width: 100%;border-collapse: collapse;">
            <tr style="width: 100%;">
                <td style="width: 100%;"><label style="margin-left: 15px;">DIAS DE GESTACIÓN&nbsp;&nbsp;<?= $value->diasGestacion ?></label></td>
            </tr>
        </table>
        <table border=0 cellspacing="2" cellpadding="3" style=" padding-left: 15px; width: 100%;">
            <tr>
                <td><label>RESEÑAS:&nbsp;&nbsp;</label><label style="text-decoration-line: underline;"><?= $resenasGeneral  /*$resenasNombresCA*/ ?></label></td>
            </tr>
        </table>
        <!--<table style="width: 100%;margin-left: 15px;border-collapse: collapse;">
            ...
            <tr style="width: 100%;">
                ...
                <td style="border: 1px solid black;width: 40%;text-align: center;"><label>&nbsp;<?= $resenasNombresAD ?></label></td>
        ...
        <table style="width: 100%;margin-left: 15px;border-collapse: collapse;font-size: 12px !important;">
            ...
            <tr style="border: 1px solid black;">
                ...
                <? if ($value->metodo == "SC") { ?>
                    <td class="print" style="border: 1px solid black;height: 50px;text-align: center;"><label style="font-weight: bold;">TRANSFERENCIA DE EMBRION</label><br>ID. RECEPTORA: <?= $value->idReceptor ?></label></td>
                <? } else { ?>
    ...
    <table style="margin-left: 25px;">
        <tr>
            <label class="space">Situación de la Inscripción: <b><?= $value->estadoSolTexto ?></b></label>
        </tr>
    </table>
<?
}
