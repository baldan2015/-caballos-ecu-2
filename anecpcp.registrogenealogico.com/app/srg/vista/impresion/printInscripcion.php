...
if (!validarSesion2()) {
    ...
    $ejemplar = $print->obteneDatosInscripcionPrint($_GET['codigo'], $_GET['codigoInscripcion'], $_GET['prop'],0);
    $vpadre;
    $vmadre;
    $vidMadre;
    $vidPadre;
    ...
    if (is_array($imagenes)) {
        foreach ($imagenes as $key => $fila) {
            if(file_exists(ConstantesPathWeb::K_PATH_INS_IMG . $fila->ruta)){
              if(substr($fila->ruta,-3) == "png"){
                $imagenesCaballo .= '<table align="center" valign="middle"><tr><td><img src="' . ConstantesPathWeb::K_PATH_INS_IMG . $fila->ruta . '" height=450 width=500></td></tr></table>' . $espacio;
              }else{
                $imagenesCaballo .= '<table align="center" valign="middle"><tr><td><img src="' . ConstantesPathWeb::K_PATH_INS_IMG . $fila->ruta . '" height=117 width=147></td></tr></table>' . $espacio;
              }
            }else{
