...
<table   style="width: 97%;margin-left: 30px;border-collapse: collapse;">
    ...
    <tr style="border: 1px solid black;">
        ...
        <?}else{?>
            <td  style="border: 1px solid black;height: 50px;text-align: center;"><label style="font-weight: bold;">MONTA NATURAL</label></td>
        <?}?>    
        <td colspan="4" style="border: 1px solid black;height: 50px;text-align: center;width: 70%;padding-left: 0px;"><label style="font-weight: bold;">INSEMINACIÓN CON:</label>
            ...
            <tr style="border: 1px solid black;">
                ...
                <?}else{?>
                    <td  style="border: 1px solid black;height: 50px;text-align: center;font-weight: bold;"><label style="font-weight: bold;">TRANSFERENCIA DE EMBRION</label><br>ID. RECEPTORA: <?=$value->idReceptor?> <br> <?=$value->fecEmbrion?></label></td>
                <?}?>  
    </tr>
</table>
<br><br><br>
<table style="margin-left: 25px;">
    <tr>
        <label class="space">Datos Servicio de Monta Relacionado</label><br><br>
    </tr>
    
    <tr>
        <label class="space">Fecha de Servicio: <?=$value->fecCrea?></label><br>
    </tr>

    <tr>
        <label class="space">Responsable de Servicio: <?=$value->usuCrea?></label><br>
    </tr>

    <tr>
        <label class="space">Fecha de Impresión: <?=$value->fechaImpresion?></label><br>
    </tr>
