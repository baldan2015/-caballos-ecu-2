...
date_default_timezone_set('UTC');
 ...
 if(!validarSesion2()){
      ...
      // echo $ejemplar->fecCapado;
        ...
        //ISABELA-TE  PADRE ABUELO PANAMEÑO
        if( $_GET['idHorse'] =='EP.17.1.0180'){

                    $idPadreEjemplar="LV PINTOR - PE-03890";
                    $prefijoPadreEjemplar="";
                    $nombPadreEjemplar="";

                    $idMadreEjemplar="AV MACARENA - PE-3692";
                    $prefijoMadreEjemplar="";
                    $nombMadreEjemplar="";

                    $idPadreEjemplar2="LV JEREZANO - PE-05629";
                    $prefijoPadreEjemplar2="";
                    $nombPadreEjemplar2="";

                    $idMadreEjemplar2="CFF CHOLITA: PE-04740";
                    $prefijoMadreEjemplar2="";
                    $nombMadreEjemplar2="";

        }
 
        //HURACAN PADRE ABUELO PANAMEÑO
        if( $_GET['idHorse'] =='EP.18.2.0125'){ 

                    $idPadreEjemplar="JLV RETRATO: PE-05851";
                    $prefijoPadreEjemplar="";
                    $nombPadreEjemplar="";

                    $idMadreEjemplar="JRM LEGULEYA - PE-00678";
                    $prefijoMadreEjemplar="";
                    $nombMadreEjemplar="";

                    $idPadreEjemplar2="LV CAUDILLO - PE-08196";
                    $prefijoPadreEjemplar2="";
                    $nombPadreEjemplar2="";

                    $idMadreEjemplar2="LV BELLISIMA - PE-13822";
                    $prefijoMadreEjemplar2="";
                    $nombMadreEjemplar2="";

        }        
        if( $_GET['idHorse'] =='EP.19.1.0200'){ 

                    $idPadreEjemplar="WF EMBAJADOR - PI 00222";
                    $prefijoPadreEjemplar="";
                    $nombPadreEjemplar="";
        ...
        if( $_GET['idHorse'] =='EP.19.1.0212'){ 


                    $ejemplar->idPadre="JFH FAVORITO - SR-7365";
                     $idPadreEjemplar="ERM GENOVES - PN 03709";
                   /* $prefijoPadreEjemplar="";
                    $nombPadreEjemplar="";
*/
                   $idMadreEjemplar="JRM GOLONDRINA - YN 04530";
                   /* $prefijoMadreEjemplar="";
                    $nombMadreEjemplar="";
       ...
       if(is_array($hijo) && count($hijo)>0){
        ...
        if((int)$ejemplar->fecCrea>20170603){
                ...
                if(is_array($resenas)){
                    ...
                    $resenasNombres=$ejemplar->reseniaBasica;
                }
        }else{
            $contador=0;
             $resenas=unserialize($ejemplar->idResenias);
                ...
                if(is_array($resenas)){
                    ...
                    if($ejemplar->reseniaBasica=='' or $ejemplar->reseniaBasica==null){
