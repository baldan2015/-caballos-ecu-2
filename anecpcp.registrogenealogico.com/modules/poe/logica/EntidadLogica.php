<?php
    ...
    class EntidadLogica{
        ...
        public function listarMisEjemplares($prop){
            $registros = $this->context->listarMisEjemplares($prop);
            return $registros;
        }
        public function listarComboPropTrans($codigo,$descripcion){
            $registros = $this->context->listarComboPropTrans($codigo,$descripcion);
            return $registros;
        }
        public function listarComboEjemplarFac($prop){
            $registros = $this->context->listarComboEjemplarFac($prop);
            return $registros;
        }
        public function listarComboEjemplarCas($prop){
            $registros = $this->context->listarComboEjemplarCas($prop);
            return $registros;
        }
    }
?>
