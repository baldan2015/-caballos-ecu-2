...
if(ValidarSession())
   ...
   $activo4="active";
?>
<script src="../script/form4.js"></script>
<script src="../script/busquedaEjemplar.js"></script>
	...
	<div class="container-fluid">
	 		...
	 		<div class="row">
	 			<div class="col-md-8"> 
	 					<tituloForm>
									Formulario: servicios de mis potros y de terceros bajo mi responsabilidad a yeguas de terceros en el año <span class="badge badge-pill badge-danger"id='lblTituloPoe'><?=$periodo?></span>
								</tituloForm>	
	 			</div>
