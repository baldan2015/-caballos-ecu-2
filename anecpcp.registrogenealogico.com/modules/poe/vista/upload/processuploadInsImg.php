...
$destination_folder		= K_PATH_INS_IMG; //upload directory ends with / (slash)
	...
	if($image_res){
		...
		if(normal_resize_image($image_res, $image_save_folder, $image_type, $max_image_size, $image_width, $image_height, $jpeg_quality))
		{
			...
			/*insert tabla galeria*/
                ...
                $response = $ins->insertarInsTMP($idHorse,$new_file_name,$esPrincipal=0,$activo=1,0,$idTipoDocumento,$codigoGenerado,$flag);
			...
			echo '<br />';
			require("../../ajax/ajaxImagen.php");
			echo listarImagenEjemplarIns($idHorse,$codigoGenerado,$edit);
