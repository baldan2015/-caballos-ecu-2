    ...
    <div class="modal-dialog  modal-lg modal-dialog-customer-pdf-add">
        <div class="modal-content " >
            <div class="modal-header bg-success">
                ...
                <h4  style="font-weight:bold;text-transform: uppercase;" class="modal-title">ADJUNTAR CERTIFICADOS PDF  - <span id="lblIdSolPdf"></span>
                </h4>
            </div>
        ...
        <form action="upload/processuploadInsPdf.php" method="post" enctype="multipart/form-data" id="MyUploadFormPdf2">
       ...
       <div class="container-fluid">
        ...
        <input name="idHorsePdf2" id="idHorsePdf2" type="hidden" value='0' />
        <input name="idTipoDoc2" id="idTipoDoc2" type="hidden" value='0' />
