...
<head>
    ...
    <title>ANECPCP - REGISTRO GENEALOGICO - IMPRESIÓN DE INSCRIPCIÓN</title>
</head>
<?
...
if (!ValidarSession()) {
    ...
    $ejemplar = $print->obteneDatosInscripcionPrint($_GET['codigo'], $_GET['codigoInscripcion'], $_GET['prop']);
    //print_r($ejemplar);
    ...
    foreach ($ejemplar as $key => $value) {
        ...
        $vidMadre= $value->idMadre;
        $vidPadre =$value->idPadre;
...
?>
        ...
        <table border=0 cellspacing="2" cellpadding="3" style=" padding-left: 15px; width: 100%;">
            <tr>
                <td colspan="1" style="text-align: center;width: 55%;"><label style="text-align: center;font-weight: bold;font-size: 30px;">REPORTE DE INSCRIPCIÓN</label></td>
        ...
        <table border=0 cellspacing="2" cellpadding="3" style=" padding-left: 15px; width: 100%;font-size: 12px !important;">
            ...
            <tr>
                <td><label>VALOR DE INSCRIPCIÓN:&nbsp;&nbsp;</label><label></label></td>
                <td><label>REPORTE DE NACIMIENTO N°:&nbsp;&nbsp;</label><label style="text-decoration-line: underline;"><?= $value->codigoNacimiento ?></label></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><label>2 FOTOS PERFIL DERECHO:&nbsp;&nbsp;</label><input type="text" style="width: 5%;" disabled="true" /></td>
                <td><label>2 FOTOS PERFIL IZQUIERDO:&nbsp;&nbsp;</label><input type="text" style="width: 5%;" disabled="true" /></td>
            </tr>
        </table>
        <table style=" padding-left: 15px; width: 100%;">
            <tr style="border: 1px solid black;width: 100%;">
                <td style="border: 1px solid black;" height="180">
        ...
        <table border=0 cellspacing="2" cellpadding="3" style=" padding-left: 15px; width: 100%;font-size: 12px !important;">
            <tr>
                <td style="width: 50%;">
                    ...
                    <label>#REG.&nbsp;&nbsp;</label>
                    <input type="text" disabled="true" value="<?=  $vidPadre ?>">
                </td>
                <td>
                    <label>PADRE:&nbsp;&nbsp;</label>
            ...
            <tr>
                <td style="width: 50%;">
                    ...
                    <label>#REG.&nbsp;&nbsp;</label>
                    <input type="text" disabled="true" value="<?=  $vidMadre ?>">
                </td>
                <td>
                    <label>PADRE:&nbsp;&nbsp;</label>
        ...
        <table border=0 cellspacing="2" cellpadding="3" style=" padding-left: 15px; width: 100%;border-collapse: collapse;font-size: 12px !important;">
            <tr style="width: 100%;">
                <td style="width: 100%;"><label style="margin-left: 15px;">DIAS DE GESTACIÓN : &nbsp;&nbsp;<span><?= $value->diasGestacion ?></span></label></td>
            </tr>
            <tr style="width: 100%;">
                <td style="width: 100%;"><label style="margin-left: 15px;">Reseñas : &nbsp;&nbsp;</label><label style="text-decoration-line: underline;"><?= $resenasGeneral /*$resenasNombresCA*/ ?></label></td>
            </tr>
        </table>
        <br>
        <br>
        ...
        <table style="width: 100%;margin-left: 15px;border-collapse: collapse;font-size: 12px !important;">
            ...
            <tr style="border: 1px solid black;">
                ...
                <? if ($value->metodo == "SC") { ?>
                    <td class="print" style="border: 1px solid black;height: 50px;text-align: center;background-color: #37EE1A;"><label style="font-weight: bold;">TRANSFERENCIA DE EMBRION</label><br>ID. RECEPTORA: <?= $value->idReceptor ?><br> <?=$value->fecEmbrion ?></label></td>
                <? } else { ?>
    ...
    if (is_array($imagenes)) {
        foreach ($imagenes as $key => $fila) {
            ...
            $html = K_PATHWEB_INS_IMG . $fila->ruta;
    ...
    ?>
            <div style="margin-left: 10%;margin-top: 30px;">
                <img src='<?= $html ?>' width="500" height="450" />
            </div>
    <?
        }
    }
    ...
    <table style="margin-left: 25px;">
        ...
        <tr>
        <?php if($value->codigoNacimiento != ""){ ?> 
            <label class="space">Código Nacimiento: <?= $value->codigoNacimiento ?></label><br>
            <?php } ?>
        </tr>
    ...
    <table style="margin-left: 25px;">
        ...
        <tr>
            <?php if($value->usuCreaMonta != ""){ ?> 
            <label class="space">Responsable del Servicio: <?= $value->usuCreaMonta ?></label><br>
            <?php } ?>
        </tr>

        <tr>
            <?php if($value->codigoMonta != ""){ ?> 
            <label class="space">Código Servicio: <?= $value->codigoMonta ?></label><br>
            <?php } ?>
        </tr>
        <tr>
    ...
    <table style="margin-left: 25px;">
        <tr>
            <label class="space">Situación del Inscripción:<b> <?= $value->estadoSolTexto ?></b></label>
        </tr>
    </table>
<?
}
