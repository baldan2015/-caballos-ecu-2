       ...
       <!-- <table style="width: 100%;margin-left: 15px;border-collapse: collapse;">
        ...
        <table style="width: 100%;margin-left: 15px;border-collapse: collapse;font-size: 12px !important;">
            ...
            <tr style="border: 1px solid black;">
                ...
                <? if ($value->metodo == "SC") { ?>
                    <td  style="border: 1px solid black;height: 50px;text-align: center;"><label style="font-weight: bold;">TRANSFERENCIA DE EMBRION</label><br>ID. RECEPTORA: <?= $value->idReceptor ?><br> <?=$value->fecEmbrion ?></label></td>
                <? } else { ?>
