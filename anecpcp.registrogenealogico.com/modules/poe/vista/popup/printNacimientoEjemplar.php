...
<div id="mvNuevoEjemplarPrint" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
         ...
         <!-- <button   type="button" id="btnPrint"  style="text-align: right;" data-dismiss="modal" class="btn btn-primary" onclick="imprimir()">Print</button>-->
          <h4 class="modal-title" id="gridSystemModalLabel">Reporte de Nacimiento</h4>
      </div>
   <!--<div id="printThis" >-->
      <!-- Modal Body -->  
      ...
      <div class="modal-body" >
        <div class="body-message">
         ...
         <table style="width: 100%;">
           <tr >
             <td><label> <h2 style="font-weight: bold;text-align: center;padding-left: 150px;">REPORTE DE NACIMIENTO </h2></label></td>
           </tr>
            <tr >
         ...
         <table>
           ...
           <tr>
             <td><label>FOTOS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SI &nbsp;</label><input type="text" style="width: 5%;" id="txtFotoPrint" disabled="true" /></td>
             <td style="padding-left: 70px;"><label  >CESION DE VIENTRE: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label><labe>N°_____</labe><label id="lblCesionPrint"></label><label>_______</label></td>
           </tr>
            <tr>
         ...
         <table style="width: 100%;">
           <tr style="border: 1px solid black;width: 100%;">
            <td style="border: 1px solid black;" height="300"> <h5 style="text-align: center;">IMAGEN</h5></td>
           </tr>
         </table>
         <table>
           <tr style="height: 20%;"> 
             ...
             <td style="padding-bottom: 15px;padding-left: 80px;""  ><label  >PADRE:&nbsp;</label><label id="lblAbueloPadrePrint" style="text-decoration: underline;"></label>&nbsp;<label>#Reg.&nbsp;&nbsp;</label><input type="text" name="" id="txtIdAbueloPadrePrint"></td>
           </tr>
           <tr>
             ...
             <td  style="padding-bottom: 15px;padding-left: 80px;""><label  >MADRE:&nbsp;</label><label id="lblAbuelaPadrePrint" style="text-decoration: underline;"></label>&nbsp;<label>#Reg.&nbsp;&nbsp;</label><input type="text" name="" id="txtIdAbuelaPadrePrint"></td>
           </tr>
           <tr>
             ...
             <td  style="padding-bottom: 15px;padding-left: 80px;""><label  >PADRE:&nbsp;</label><label id="lblAbueloMadrePrint" style="text-decoration: underline;"></label>&nbsp;<label>#Reg.&nbsp;&nbsp;</label><input type="text" name="" id="txtIdAbueloMadrePrint"></td>
           </tr>
           <tr>
             ...
             <td  style="padding-bottom: 15px;padding-left: 80px;""><label  >MADRE:&nbsp;</label><label id="lblAbuelaMadrePrint" style="text-decoration: underline;"></label>&nbsp;<label>#Reg.&nbsp;&nbsp;</label><input type="text" name="" id="txtIdAbuelaMadrePrint"></td>
           </tr>
           <tr style="width: 100%;">
