...
<script src="../script/generales/loadInsPdf.js"></script>
<script src="../script/busquedaEjemplar_fase2_importado.js"></script>
<style>
  ...
  <div class="modal-dialog  modal-lg modal-dialog-customer">
    <div class="modal-content " id="divContainer">
      <div class="modal-header bg-success">
        <div class="row">
          <div class="col-md-5">
            <h4><img src="../../../home/img/ins.jpg" class="image_redonda_min" /><span class="modal-title" style="padding-left: 10px;">INSCRIPCIÓN DE EJEMPLAR.</span></h4>
          </div>
          <div class="col-md-2" style="margin-top: 10px;text-align: end;">
            <label>Seleccione Código de Nacimiento: <span class="etiqueta">(*)</span> &nbsp; </label>
          </div>
          <div class="col-md-4">
            <select id="ddlIdNac" class="form-control  input-sm selectpicker show-tick " data-live-search="true" data-size="10" data-width="100%" onchange="getInfoNacEjemplar()">
            </select>
          </div>
          <div class="col-md-1">
      ...
      <div class="modal-body">
        ...
        <div class="container-fluid">
          ...
          <div id="divResenas" class="row">
            <div class="col-md-6" style="margin-top: 7px;">
              <input type="hidden" id="array" name="array" value="" />
              <label>Rese&ntilde;as:</label>
              <button id="btnBuscarResenia" class="btn btn-primary btn-xs" title="IR A SELECCIONAR RESE&Ntilde;AS">
                <span class="glyphicon glyphicon-new-window"></span>
              </button>
              <textarea class="form-control" rows="2" cols="17" id="txtAResenia" readonly="true"></textarea>
            </div>
            <div id="divAnotaciones" class="col-md-6" style="margin-top: 7px;">
          ...
          <div class="row">
            <div class="col-md-12" style="margin-top: 7px;">
              <label> Criador: </label><span> <select id="ddlCriador" class="form-control"></select></span>
            </div>
          </div>
          <div class="row">
            <div class="col-md-3" style="margin-top: 7px;">
              <label>Madre</label>
              <label class="form-control" disabled style="font-size: 10px;" id="lblYegua"></label>
              <div class="input-group" id="btnBuscarMadreSpan">
                <label class="form-control" disabled style="font-size: 10px;" id="lblYeguaBuscar"></label>
                <input type="hidden" id="hidIdMadre" />
                <span class="input-group-btn">
                  <button type="button" data-toggle='tooltip' title="ir a buscar mi ejemplar hembra o bajo mi propiedad" id="btnBuscarMadre" class='btn btn-success glyphicon glyphicon-search'></button>
                </span>
              </div>
            </div>
            <div class="col-md-3" style="margin-top: 7px;">
              <label>Padre</label><br>
              <label class="form-control" disabled style="font-size: 10px;" id="lblPotro"></label>
              <div class="input-group" id="btnBuscarPadreSpan">
                <label class="form-control" disabled style="font-size: 10px;" id="lblPotroBuscar"></label>
                <input type="hidden" id="hidIdPadre" />
                <span class="input-group-btn">
                  <button type="button" data-toggle='tooltip' title="ir a buscar mi ejemplar macho o bajo mi propiedad" id="btnBuscarPadre" class='btn btn-success glyphicon glyphicon-search'></button>
                </span>
              </div>
            ...
            <div class="col-md-2" style="margin-top: 7px;">
              ...
              <div id="cboMetodoReproductivoDiv">
                <select class="form-control input-sm selectpicker show-tick" data-live-search="true" data-size="10" data-width="100%" id="cboMetodoReproductivo">
                </select>
              </div>
            ...
            <div id="FecEmbrion" class="col-md-1" style="margin-top: 7px;">
              <label> Fecha Embrión: </label>
              <label class="form-control" disabled style="font-size: 10px;" id="lblFecEmbrion"></label>
            </div>
            <div id="idReceptora" class="col-md-1" style="margin-top: 7px;">
              <label> ID Receptora: </label>
              <label class="form-control" disabled style="font-size: 10px;" id="lblIdReceptora"></label>
            </div>
            <div class="col-md-2" style="margin-top: 7px;" id="divReporte">
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <label class="form-control" disabled style="font-size: 10px;" id="lblIdNac"></label>
            ...
            <div class="col-md-2" id="divFechaServicio" style="margin-top: 7px;">
              <label>Fecha de Servicio:</label>
              <input type="date" class="form-control" id="dtFecServ">
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div id="upload-wrapper">
                ...
                <form action="upload/processuploadInsImg.php" method="post" enctype="multipart/form-data" id="MyUploadForm">
            ...
            <div class="col-md-6">
              <div id="upload-wrapper">
                ...
                <h5 style="text-transform: uppercase;padding-left: 15px;font-weight: bold;">Agregar Certificados PDF: <span class="badge badge-pill badge-warning-tit" id="lblDatoHorsePdf" style="font-weight: bold;"></span> </h5>
                <form action="upload/processuploadInsPdf.php" method="post" enctype="multipart/form-data" id="MyUploadFormPdf">
            ...
            <div class="col-md-5" style="margin-bottom: 3px;">
              <label id="lblTipoD">Tipo de documento</label>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <input type="submit" class="btn   btn-primary" id="submit-btn-pdf" title="Cargar documento PDF" value="&#9650; PDF " />
                    </div>
                  </div>
      ...
      <div class="modal-footer">
        <button type="button" id="btnSaveNE" class="btn btn-primary">Grabar </button>
        <button type="button" id="btnSaveBaja" class="btn btn-primary" style="display: none;">Grabar Baja </button>
...
<!-- <input type="hidden" id="hidOrigenBuscador" />
        ...
        <button id="btnBGBuscarEjemplar" class="btn-xs btn-success" onclick="return initDataTableGrlEjemplar();">Buscar</button>
        <hr>
        <div>
...
<div class="modal fade" id="mvPdf1" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="doc-container">
          <iframe id="ifrPDF1" style="width: 100%;" frameborder="0" allowfullscreen></iframe>
          <div class="modal-footer">
            <!--<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>-->
          </div>
        </div>
