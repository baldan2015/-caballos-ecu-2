...
<div style=" float:right;  " class="toolButton ">
    ...
    <span class="glyphicon glyphicon-print">&nbsp;Imprimir Consolidado</span>
    </button>

    <button id="btnCancelar"  title="Reiniciar filtros de búsqueda  " class="btn btn-default btn-md" >
    <span class="glyphicon glyphicon-refresh">&nbsp;Nueva Busqueda</span>
    </button>
 &nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div class="col-md-2">
           ...
           <div class="col-md-4">
            ...
            <div id="radioBtn" class="btn-group">
              <a class="btn btn-default btn-sm active " data-toggle="hidOrigen" data-title="T" title="No considerar origen">TODOS</a>
              <a class="btn btn-default btn-sm notActive" data-toggle="hidOrigen" data-title="N"  title="Considerar s&oacute;lo ejemplares nacionales">NACIONAL</a>
               <a class="btn btn-default btn-sm notActive" data-toggle="hidOrigen" data-title="I"  title="Considerar s&oacute;lo ejemplares importados">IMPORTADO</a>
            </div>
