...
$(document).ready(function () {
    ...
    $('#MyUploadForm').submit(function (e) {
        // e.preventDefault();   
        //if($("#hidFlagEdit").val()==1){
        // var result = confirm("Está seguro de registrar la siguiente imagen?");
        //alertify.confirm("Está seguro de registrar la siguiente imagen?", function (e) {
        //if(result){
