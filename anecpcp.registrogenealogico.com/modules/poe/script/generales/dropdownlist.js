...
var listarPelaje = function (control, mensaje, valor = 0) {
    var val = valor;
    $("#" + control + " option").remove();
    $("#" + control).append("<option value='0'>" + mensaje + "</option>");
    ...
    $.ajax({
        url: K_PATH_ROOT + 'ajax/ajaxPelaje.php',
        data: {
            opc: "lstItems"
        },
        type: 'POST',
...
var listarResenia = function (control, mensaje, valor) {
    ...
    $.ajax({
        url: K_PATH_ROOT + 'ajax/ajaxResena.php',
        data: {
            opc: "lstItems",
            tipo: valor,
            descripcion:mensaje
            ...
            if (dato.result == K_ResultadoCboAjax.exito) {
                if (resenas != null) {
                    $.each(resenas, function (index, item) {
                        ...
                        $("#" + control).append("<option data-tp='"+item.tipo+"' value='" + item.valor + "' " + selected + "  title='" + item.descripcion + "'>" + item.descripcion + "</option>");
                    });
                }
...
var listarDeparmento = function (control, mensaje, valor) {
    ...
    $.ajax({
        url: K_PATH_ROOT + 'ajax/ajaxDepartamento.php',
        data: {
            opc: "lstItems"
        },
        type: 'POST',
...
var listarPropietarioID = function (control, mensaje, valor) {
    ...
    var items = "<option   value='0'>" + mensaje + "</option>";
    $.ajax({
        url: 'modules/poe/ajax/ajaxEntidad.php',
        data: {
            opc: "lstItemsProp"
        },
        type: 'POST',
...
var listarCriador = function (control, mensaje, valor) {
    ...
    var items = "<option value='0'>" + mensaje + "</option>";
    $.ajax({
        url: K_PATH_ROOT + 'ajax/ajaxEntidad.php',
        data: {
            opc: "lstItemsCria"
        },
        type: 'POST',
...
/*--------------------------------------------- INICIO DE LA FASE2 ---------------------*/
var listarEstados = function (control, mensaje, valor) {
    var val = valor == undefined ? 0 : valor;
    $("#" + control + "option").remove();
    $("#" + control).append("<option value='0'>" + mensaje + "</option>");
    var items = "<option data-tokens='0'>" + mensaje + "</option>";
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var metodo = dato.data;
            if (dato.resultado == K_ResultadoCboAjax.exito) {
...
var listarDocumentoPropietario = function (control, mensaje, valor) {
    ...
    $("#" + control).append("<option value='0'>" + mensaje + "</option>");
    $.ajax({
        url: 'modules/poe/ajax/ajaxTipoDoc.php',
        data: {
            opc: "lstItems"
        },
        type: 'POST',
...
var listarMetodoRepropL = function (control, mensaje, valor) {
    var val = valor == undefined ? 0 : valor;
    $("#" + control + "option").remove();
    $("#" + control).append("<option value='0'>" + mensaje + "</option>");
    var items = "<option data-tokens='0'>" + mensaje + "</option>";
