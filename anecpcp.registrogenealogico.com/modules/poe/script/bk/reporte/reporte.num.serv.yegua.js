...
function fillGrafica(labels,data,bgcolors){
	// Bar chart
var titulo="CONSOLIDADO DE SERVICIO DE YEGUAS ENTRE POE - SGE ";
...
var  param={opc:'rptNumServY',desde:$("#txtDesde").val(),hasta:$("#txtHasta").val()};
...
function viewDeta(anio){
	 ...
	 $(".modal-title").html("Detalle servicio yeguas año: "+anio);
	 reporteDet(anio);
}
function reporteDet(ianio,isXls){
var  param={opc:'rptNumServYDet',anio:ianio,nombre:$("#txtNombreDet").val()};
