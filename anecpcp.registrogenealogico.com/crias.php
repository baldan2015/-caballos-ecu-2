...
if(ValidarSession())
	...
	<!--<a href="javascript:self.close();">cerrar ventana &nbsp<img src='img/s_error2.png' border=0></a>	--><?
	echo"</td></tr>";
	}
else
	{
...
?></TR><tr ROWSPAN=0>
<td align=center valign=top colspan=2   height=50>
<img src="img/top.png"  border=0><hr>
</td>
</TR>
<?
echo"<tr><td colspan=2 valign=center ><br><br>";
	///////////////////////////////////////////////////////////////////////////////////////////
